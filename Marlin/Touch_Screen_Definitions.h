...
#define FORM_CUSTOM_CALIB					22
	#define BUTTON_CUSTOM_BACK_MAINTENANCE	 78
	#define BUTTON_CUSTOM_X_UP				 70
	#define BUTTON_CUSTOM_X_DOWN			 65
	#define BUTTON_CUSTOM_ACCEPT TEST		 79
...
#define FORM_ADJUSTING_TEMPERATURES					26	
	#define GIF_ADJUSTING_TEMPERATURES			1
